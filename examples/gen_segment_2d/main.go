...
//
// Usage:
//   VISVISE_APP_ID=xxx VISVISE_SECRET_KEY=xxx VISVISE_UID=xxx VISVISE_ENV=prod MV_360_MODEL_ID=xxx go run main.go
...
func main() {
	...
	segModelID, err := client.GenSegment2D(mvModelID,
